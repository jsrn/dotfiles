...
map("n", "<leader>gs", ":Telescope lsp_document_symbols<cr>", { desc = "find symbol in file" })
map("n", "<leader>gS", ":Telescope lsp_dynamic_workspace_symbols<cr>", { desc = "find symbol in project" })
